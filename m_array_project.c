...
void initAnimalName();  // 동물 이름
void shuffleAnimal();   // 카드 섞는 함수
int getEmptyPosition(); // 좌표에서 빈 공간 찾기기
int foundAllAnimals(); //
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if (select1 == select2) // 같은 카드를 선택했을 경우 무효
        continue;
...
void printQuestion() // 문제 출력력
{
    ...
    // ㅁㅁㅁㅁㅁ 10 11 12 13 14            0 0 0 0 1
